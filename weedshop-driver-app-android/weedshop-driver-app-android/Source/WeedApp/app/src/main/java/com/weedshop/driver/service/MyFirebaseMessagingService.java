package com.weedshop.driver.service;
...
import com.weedshop.driver.MainActivity;
        ...
        try {
           ...
           /* if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            if (type.equalsIgnoreCase(String.valueOf(Config.ACCOUNT_APPROVED_ID))) {
                SharedPreferences sharedpreferences = getApplicationContext().getSharedPreferences(Constant.LOGIN_USER_PREF, Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putBoolean(ISVERYFINEPERDETAIL, true);
                editor.apply();
                resultIntent = new Intent(getApplicationContext(), MainActivity.class);
            } else if (type.equalsIgnoreCase(String.valueOf(Config.ORDER_AVAILABLE_ID))) {
                resultIntent = new Intent(getApplicationContext(), MainActivity.class);
            } else {
                resultIntent = new Intent(getApplicationContext(), MainActivity.class);
            }
