...
public class AddIdentificationActivity extends AppCompatActivity implements OnTaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddId = (Button) findViewById(R.id.btn_add_id);
        btnAddId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               /* Intent m_intent = new Intent(AddIdentificationActivity.this, UploadRecommendationActivity.class);
        ...
        findViewById(R.id.btnlogout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CommonUtils.logoutAlert(AddIdentificationActivity.this, "Are you sure you want to Logout?");
            }
        });
    }
            ...
            public void onClick(DialogInterface dialog, int item) {
                if (items[item].equals("Take Photo")) {
                    ...
                    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                        ...
                        fileUri = FileProvider.getUriForFile(AddIdentificationActivity.this, getPackageName() + ".provider", file);
    ...
    private void requestCameraPermissions() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AddIdentificationActivity.this, CAMERA)
                || ActivityCompat.shouldShowRequestPermissionRationale(AddIdentificationActivity.this, WRITE_EXTERNAL_STORAGE)) {
    ...
    private void uploadFile(String file) {
        ...
        map.put("file", file);
        ServiceHandler task = new ServiceHandler(AddIdentificationActivity.this, Constant.identificationPhoto_Upload, map, true, this.getApplicationContext());
        task.executeAsync();
    }
    ...
    public void onTaskCompleted(String result, int requestCode) {
        if (!TextUtils.isEmpty(result)) {
            try {
                ...
                if (response) {
                    Toast.makeText(AddIdentificationActivity.this, msg, Toast.LENGTH_LONG).show();
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putBoolean(Constant.ISPHOTOUPLOAD, true);
                    editor.apply();

                    if (getIntent().hasExtra("redirect")) {
                        boolean isRedirect = getIntent().getBooleanExtra("redirect", false);
                        if (isRedirect) {
                            Intent m_intent = new Intent(AddIdentificationActivity.this, VerifyProcessActivity.class);
                            startActivity(m_intent);
                            finish();
                            return;
                        }
                    ...
                    Intent m_intent = new Intent(AddIdentificationActivity.this, CarDetailsActivity.class);
                    startActivity(m_intent);
                } else {
                    Toast.makeText(AddIdentificationActivity.this, msg, Toast.LENGTH_LONG).show();
                }
